 ...
 * @generated
 */
public class CFG_CategorieAbilitateLocalServiceClp
    ...
    public CFG_CategorieAbilitateLocalServiceClp(
        ...
        _methodName19 = "getAllCFG_CategorieAbilitate";

        _methodParameterTypes19 = new String[] {  };

        _methodName20 = "getCFG_CategorieAbilitateByClassName";

        _methodParameterTypes20 = new String[] { "java.lang.String" };

        _methodName21 = "getCFG_CategorieAbilitateByClassNameAndDefaultRicerca";

        _methodParameterTypes21 = new String[] { "java.lang.String", "boolean" };

        _methodName22 = "getSelectedByClassName";
    ...
    public it.sincon.sanita.services.model.CFG_CategorieAbilitate addCFG_CategorieAbilitate(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(cfg_CategorieAbilitate)
                    });
        } catch (Throwable t) {
        ...
        return (it.sincon.sanita.services.model.CFG_CategorieAbilitate) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public it.sincon.sanita.services.model.CFG_CategorieAbilitate createCFG_CategorieAbilitate(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { ClpSerializer.translateInput(titoloStruttura) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<it.sincon.sanita.services.model.CFG_CategorieAbilitate> getCFG_CategorieAbilitates(
        ...
        return (java.util.List<it.sincon.sanita.services.model.CFG_CategorieAbilitate>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<it.sincon.sanita.services.model.CFG_CategorieAbilitate> getSelectedByClassName(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName22,
                    ...
                    ClpSerializer.translateInput(jsonCategorie)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
