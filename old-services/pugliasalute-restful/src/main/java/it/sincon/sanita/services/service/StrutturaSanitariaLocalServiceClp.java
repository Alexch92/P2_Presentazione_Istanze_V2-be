 ...
 * @generated
 */
public class StrutturaSanitariaLocalServiceClp
    ...
    public StrutturaSanitariaLocalServiceClp(
        ...
        _methodName19 = "replaceAll";

        _methodParameterTypes19 = new String[] { "java.util.List" };

        _methodName20 = "findByIdStrutturaAndLocale";
    ...
    public it.sincon.sanita.services.model.StrutturaSanitaria addStrutturaSanitaria(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(strutturaSanitaria)
                    });
        } catch (Throwable t) {
        ...
        return (it.sincon.sanita.services.model.StrutturaSanitaria) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<it.sincon.sanita.services.model.StrutturaSanitaria> getStrutturaSanitarias(
        ...
        return (java.util.List<it.sincon.sanita.services.model.StrutturaSanitaria>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public long replaceAll(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    new Object[] { ClpSerializer.translateInput(newItemsList) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public long searchCount(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName21,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(listaIdTipoStrutture),
                        
                    ClpSerializer.translateInput(listaIdStrutture),
                        
                    ClpSerializer.translateInput(fullText),
    ...
    public java.util.List<it.sincon.sanita.services.model.StrutturaSanitaria> search(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName22,
                    ...
                    ClpSerializer.translateInput(mobile_latitude),
                        
                    ClpSerializer.translateInput(mobile_longitude),
