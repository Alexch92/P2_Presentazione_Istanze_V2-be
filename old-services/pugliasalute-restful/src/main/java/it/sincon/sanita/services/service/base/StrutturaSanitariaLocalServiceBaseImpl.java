...
import it.sincon.sanita.services.service.StrutturaSanitariaLocalService;
...
/**
 * Provides the base implementation for the struttura sanitaria local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.sincon.sanita.services.service.impl.StrutturaSanitariaLocalServiceImpl}.
 * </p>
 *
 * @author Sincon
 ...
 * @generated
 */
public abstract class StrutturaSanitariaLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements StrutturaSanitariaLocalService,
        IdentifiableBean {
    ...
    private StrutturaSanitariaLocalServiceClpInvoker _clpInvoker = new StrutturaSanitariaLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link it.sincon.sanita.services.service.StrutturaSanitariaLocalServiceUtil} to access the struttura sanitaria local service.
     */
    ...
    @Override
    public StrutturaSanitaria addStrutturaSanitaria(
        StrutturaSanitaria strutturaSanitaria) throws SystemException {
        strutturaSanitaria.setNew(true);

        return strutturaSanitariaPersistence.update(strutturaSanitaria);
    }
     ...
     */
    @Override
    public StrutturaSanitaria createStrutturaSanitaria(long pk) {
        return strutturaSanitariaPersistence.create(pk);
    }
    ...
    @Override
    public StrutturaSanitaria deleteStrutturaSanitaria(long pk)
        throws PortalException, SystemException {
        return strutturaSanitariaPersistence.remove(pk);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public StrutturaSanitaria deleteStrutturaSanitaria(
        StrutturaSanitaria strutturaSanitaria) throws SystemException {
        return strutturaSanitariaPersistence.remove(strutturaSanitaria);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(StrutturaSanitaria.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return strutturaSanitariaPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return strutturaSanitariaPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public StrutturaSanitaria fetchStrutturaSanitaria(long pk)
        throws SystemException {
        return strutturaSanitariaPersistence.fetchByPrimaryKey(pk);
    }
     ...
     */
    @Override
    public StrutturaSanitaria getStrutturaSanitaria(long pk)
        throws PortalException, SystemException {
        return strutturaSanitariaPersistence.findByPrimaryKey(pk);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return strutturaSanitariaPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<StrutturaSanitaria> getStrutturaSanitarias(int start, int end)
        throws SystemException {
        return strutturaSanitariaPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getStrutturaSanitariasCount() throws SystemException {
        return strutturaSanitariaPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public StrutturaSanitaria updateStrutturaSanitaria(
        StrutturaSanitaria strutturaSanitaria) throws SystemException {
        return strutturaSanitariaPersistence.update(strutturaSanitaria);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("it.sincon.sanita.services.model.StrutturaSanitaria",
            strutturaSanitariaLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = strutturaSanitariaPersistence.getDataSource();
