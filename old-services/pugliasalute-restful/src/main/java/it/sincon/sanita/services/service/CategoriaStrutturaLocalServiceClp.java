 ...
 * @generated
 */
public class CategoriaStrutturaLocalServiceClp
    ...
    public CategoriaStrutturaLocalServiceClp(
    ...
    public it.sincon.sanita.services.model.CategoriaStruttura addCategoriaStruttura(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(categoriaStruttura)
                    });
        } catch (Throwable t) {
        ...
        return (it.sincon.sanita.services.model.CategoriaStruttura) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public it.sincon.sanita.services.model.CategoriaStruttura createCategoriaStruttura(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { ClpSerializer.translateInput(idTipoStruttura) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<it.sincon.sanita.services.model.CategoriaStruttura> getCategoriaStrutturas(
        ...
        return (java.util.List<it.sincon.sanita.services.model.CategoriaStruttura>) ClpSerializer.translateOutput(returnObj);
    }
