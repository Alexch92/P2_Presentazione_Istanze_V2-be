...
public class RichiestaLogin  implements java.io.Serializable {
    private it.puglia.sanita.cup.Operatore operatore;

    public RichiestaLogin() {
    }
    ...
    /**
     * Gets the operatore value for this RichiestaLogin.
     * 
     * @return operatore
     */
    ...
    /**
     * Sets the operatore value for this RichiestaLogin.
     * 
     * @param operatore
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RichiestaLogin)) return false;
        RichiestaLogin other = (RichiestaLogin) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RichiestaLogin.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://cup.sanita.puglia.it/", "RichiestaLogin"));
