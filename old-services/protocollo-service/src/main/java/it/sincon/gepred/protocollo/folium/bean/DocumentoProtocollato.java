...
package it.sincon.gepred.protocollo.folium.bean;
...
public class DocumentoProtocollato  implements java.io.Serializable {
    ...
    private it.sincon.gepred.protocollo.folium.bean.WSEsito esito;

    private java.lang.Long id;

    private boolean isContenuto;

    private it.sincon.gepred.protocollo.folium.bean.MittenteDestinatario[] mittentiDestinatari;
    ...
    public DocumentoProtocollato(
           ...
           it.sincon.gepred.protocollo.folium.bean.WSEsito esito,
           java.lang.Long id,
           boolean isContenuto,
           it.sincon.gepred.protocollo.folium.bean.MittenteDestinatario[] mittentiDestinatari,
     ...
     * @return esito
     */
    public it.sincon.gepred.protocollo.folium.bean.WSEsito getEsito() {
        return esito;
    }
     ...
     * @param esito
     */
    public void setEsito(it.sincon.gepred.protocollo.folium.bean.WSEsito esito) {
        this.esito = esito;
    }
     ...
     */
    public it.sincon.gepred.protocollo.folium.bean.MittenteDestinatario[] getMittentiDestinatari() {
        return mittentiDestinatari;
    }
     ...
     */
    public void setMittentiDestinatari(it.sincon.gepred.protocollo.folium.bean.MittenteDestinatario[] mittentiDestinatari) {
        this.mittentiDestinatari = mittentiDestinatari;
    }
