...
INSERT INTO tb_profilo_utente_cittadino (ID, codice_fiscale, cognome, nome, ind_nr_civico,pec, ind_via, fk_ind_comune, fk_professionista) VALUES ( 'cittadino_1', '               1', 'Doe #1', 'John #1', '1', '','via De Pippis #1', 1, null );
INSERT INTO tb_profilo_utente_cittadino (ID, codice_fiscale, cognome, nome, ind_nr_civico,pec, ind_via, fk_ind_comune, fk_professionista) VALUES ( 'cittadino_2', '               2', 'Doe #2', 'John #2', '2', '','via De Pippis #2', 2, null );
INSERT INTO tb_profilo_utente_cittadino (ID, codice_fiscale, cognome, nome, ind_nr_civico,pec, ind_via, fk_ind_comune, fk_professionista) VALUES ( 'cittadino_3', '               3', 'Doe #3', 'John #3', '3', '','via De Pippis #3', 3, null );
INSERT INTO tb_profilo_utente_cittadino (ID, codice_fiscale, cognome, nome, ind_nr_civico,pec, ind_via, fk_ind_comune, fk_professionista) VALUES ( 'cittadino_4', '               4', 'Doe #4', 'John #4', '4', '','via De Pippis #4', 4, null );
INSERT INTO tb_profilo_utente_cittadino (ID, codice_fiscale, cognome, nome, ind_nr_civico,pec, ind_via, fk_ind_comune, fk_professionista) VALUES ( 'cittadino_5', '               5', 'Doe #5', 'John #5', '5', '','via De Pippis #5', 5, null );
INSERT INTO tb_profilo_utente_cittadino (ID, codice_fiscale, cognome, nome, ind_nr_civico,pec, ind_via, fk_ind_comune, fk_professionista) VALUES ( 'cittadino_6', '               6', 'Doe #6', 'John #6', '6', '','via De Pippis #6', 6, null );
INSERT INTO tb_profilo_utente_cittadino (ID, codice_fiscale, cognome, nome, ind_nr_civico,pec, ind_via, fk_ind_comune, fk_professionista) VALUES ('10169','mccmhl','Birtolo','Maria Michela','1','michela.birtolo@libero.it','via xxx',1,null );
