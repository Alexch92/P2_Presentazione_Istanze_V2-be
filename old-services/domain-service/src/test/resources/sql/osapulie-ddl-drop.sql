ALTER TABLE tb_profilo_utente_cittadino DROP FOREIGN KEY FK_tb_profilo_utente_cittadino_fk_professionista;
ALTER TABLE tb_profilo_utente_cittadino DROP FOREIGN KEY FK_tb_profilo_utente_cittadino_fk_ind_comune;
ALTER TABLE tb_profilo_utente_professionista DROP FOREIGN KEY FK_tb_profilo_utente_professionista_fk_ind_comune;
