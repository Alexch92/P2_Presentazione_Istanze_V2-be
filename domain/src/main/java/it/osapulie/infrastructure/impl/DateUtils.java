...
//            return false;
	...
	/** 
	 * Restituisce la startDate cui viene sommato il nr di giorni passato in input...
	 * @param startDate
	 * @param nrDaysTBA
	 * @return
	 */
	public static Date AddDays(Date startDate, int nrDaysTBA)
	{
		Calendar c = Calendar.getInstance();
		//Setting the date to the given date
		   
		//Number of Days to add
		c.add(Calendar.DAY_OF_MONTH, nrDaysTBA); 
...
//	}
	...
	public static int getDifferenceInDays(Date newerDate, Date olderDate) {
