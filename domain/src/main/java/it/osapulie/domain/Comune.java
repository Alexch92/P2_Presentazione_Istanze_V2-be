...
public class Comune extends AbstractPersistable<Long> implements Serializable {
	...
	public Integer getCodiceComune() {
		return this.codiceComune;
	}

	public void setCodiceComune(Integer codiceComune) {
	...
	public String getCodicestat107() {
		return this.codicestat107;
	}

	public void setCodicestat107(String codicestat107) {
		this.codicestat107 = codicestat107;
	}
