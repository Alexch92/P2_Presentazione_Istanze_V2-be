...
//		return "Indirizzo [via=" + via + ", nrCivico=" + nrCivico + ", comuneISA=" + comune.getDenominazione() + "]";
		
		String comuneDenominazione = "";
		String siglaProvincia = "";
		String formato = "%s, %s";
		if (comune!=null){
			comuneDenominazione = comune.getDenominazione();
			formato = "%s, %s - %s";
		...
		return String.format(formato, via, nrCivico, comuneDenominazione, siglaProvincia);
	}
